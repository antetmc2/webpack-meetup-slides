...
```notes
Mention issues present today. Even thought we have a lot of options for web management, we have issues like a lot of files, order of adding stylesheets and 
scripts into HTML, file optimization and more. We have most popular solution for that - Webpack.
```
